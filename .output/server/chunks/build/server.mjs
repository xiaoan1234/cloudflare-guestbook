import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject, hasInjectionContext, getCurrentInstance, defineComponent, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, computed, unref, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, shallowRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL$1, f as encodePath$1, m as decodePath, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, e as createError$1, y as executeAsync, z as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-pQ2GXLn8.mjs')
  },
  {
    name: "guestbook",
    path: "/guestbook",
    component: () => import('./guestbook-CR2iiY5M.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-CrXhBcGK.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C3DVHi5p.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CYXKbhKx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CPgXUvBQ.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useRouter as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, useRouter$1 as u };
